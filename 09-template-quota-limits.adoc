...
link:https://docs.openshift.com/container-platform/4.10/openshift_images/using-templates.html[template documentation^].
...
link:https://docs.openshift.com/container-platform/4.10/applications/quotas/quotas-setting-per-project.html[quota
documentation^]
...
link:https://docs.openshift.com/container-platform/4.10/nodes/clusters/nodes-cluster-limit-ranges.html[limit
...
link:https://docs.openshift.com/container-platform/4.10/applications/quotas/quotas-setting-across-multiple-projects.html[multi-project
